...
def generate_route_note():
    msgs = [
        make_route_note('msg 1', 1, 1),
        make_route_note('msg 2', 2, 2),
        make_route_note('msg 3', 3, 3),
        make_route_note('msg 4', 4, 4),
        make_route_note('msg 5', 4, 4)
    ]
    for msg in msgs:
...
def run():
    ...
    print(
        'point count: {point_count} feature count: {feature_count} distance: {distance} elapsed time:{elapsed_time}'.format(
    ...
    for msg in response:
        print('receive message {message} location {location}'.format(message = msg.message, location = msg.location))
